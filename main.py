...
def main():
    ...
    testFiles = fileProcessor.loadDataFiles(TEST_DOCUMENTS)
    ...
    for file in testFiles:
        try:
            with open(str(TEST_DOCUMENTS + file), "r", encoding="utf8", errors='ignore') as f:
    ...
    # Print confusion matrix and other Performance Measures
    console.log("printing the performance measures")
